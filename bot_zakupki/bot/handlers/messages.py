...
NEW_QUERY_MSG = (
    ...
    "\"<b>Мне повезет</b>\" и мы будем присылать по 20 закупок в день, "
    "подходящих по остальным параметрам: цене и региону поставки.\n"
    "\n"
...
CHANGE_QUERY_MSG = (
    ...
    "- <b>шоколад торт</b>, а не шоколадные торты\n"
    "\n"
    "Если предмет закупки для вас не столь важен, то нажмите на кнопку "
    "<b>Мне повезет</b> и мы будем присылать вам по 20 закупок, "
    "подходящих остальным параметрам: цене и региону поставки.\n"
    "\n"
    "Итак, введите ключевое слово или словосочетание:\n"
)
...
SET_MAX_PRICE = (
    "И наконец максимальную цену в рублях." "Например: <b>10 000 000</b>"
)
